...
<div class="row gx-3">
    ...
    <div class="col-2 col-xl-6">
        <div class="float-end">
         <a href="/admin/partner" class="btn btn-outline-primary" > + </a>
        </div>
    </div>
</div>
    <!-- Row end -->
        ...
        <div class="card mb-3">
            <div class="card-body">
                <div class="table-outer">
                            ...
                            If (isset($parceiros)) {
                                foreach ($parceiros as $parceiro) { ?>
                                    <tr>
                                        ...
                                        <td class="fw-bold"> 
                                            <?=
                                                !is_null($parceiro->arquivo_id) ? 
                                                '<a href="#" data-bs-toggle="modal" data-bs-target="#staticBackdrop-'.$parceiro->id.'" ><img src="/Public/'. getJsonToObject($parceiro->arquivo)->path .'" class="img-2x me-2 rounded-3"
                                            alt="Bootstrap Gallery" /></a>' : 
                                                '<a href="#" data-bs-toggle="modal" data-bs-target="#staticBackdrop-'.$parceiro->id.'" ><img src="/Public/admin/assets/images/bg.jpg" class="img-2x me-2 rounded-3"
                                            alt="Bootstrap Gallery" /></a>';
                                            ?>
                                            <span class="fw-semibold"><?=$parceiro->nome?></span>
                                            <div class="modal fade" id="staticBackdrop-<?=$parceiro->id?>" data-bs-backdrop="static" data-bs-keyboard="false"
                                                            ...
                                                            <div class="row gx-3">
                                                                <div class="col-sm-12 col-12">
                                                                    <div id="update-profile" class="mb-3">
                                                                        <form action="/admin/partner/<?=$parceiro->uuid?>/upload" class="dropzone sm needsclick dz-clickable"
                                        ...
                                        <td >
                                            <div class="d-none d-xl-flex d-lg-flex d-md-flex">
                                                <a class="mb-1 me-2 mt-1" href="/admin/partner/<?=$parceiro->uuid?>">
                                                ...
                                                <? 
                                                    if ($parceiro->ativo == 1) { ?>
                                                        <button class="btn btn-outline btn-sm" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal_<?=$parceiro->uuid?>">                                                     
                                                            <div class="border p-2 rounded-3">
                                                ...
                                                <? 
                                                    if ($parceiro->ativo == 0) { ?>
                                                       <a class="btn btn-outline btn-sm" href="\admin\partner\<?=$parceiro->uuid?>\active">                                                     
                                                            <div class="border p-2 rounded-3">
                                            ...
                                            <div class="modal fade" id="exampleModal_<?=$parceiro->uuid?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <p>parceiro: <?=$parceiro->nome?></p>
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                                                            <button type="submit" onclick="deleteData('/admin/partner/<?=$parceiro->uuid?>')" class="btn btn-danger">Confirmar Exclusão</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <div class="text-end ">
                        Total <b><?=count($parceiros ?? [])?></b> registros
                    </div>
                </div>
            </div>
        </div>
